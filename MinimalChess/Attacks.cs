...
#pragma warning restore CA2211 
    ...
    static readonly int[] DIAGONALS_FILE = [-1, 1, 1, -1];
    static readonly int[] DIAGONALS_RANK = [-1, -1, 1, 1];

    static readonly int[] STRAIGHTS_FILE = [-1, 0, 1, 0];
    static readonly int[] STRAIGHTS_RANK = [-0, -1, 0, 1];

    static readonly int[] KING_FILE = [-1, 0, 1, 1, 1, 0, -1, -1];
    static readonly int[] KING_RANK = [-1, -1, -1, 0, 1, 1, 1, 0];

    static readonly int[] KNIGHT_FILE = [-1, -2, 1, 2, -1, -2, 1, 2];
    static readonly int[] KNIGHT_RANK = [-2, -1, -2, -1, 2, 1, 2, 1];

    static readonly List<byte> IndexBuffer = [];
    ...
    static Attacks()
    {
        for (int index = 0; index < 64; index++)
        {
            ...
            for (int dir = 0; dir < 4; dir++)
            {
                Queen[index][dir] = 
                    Bishop[index][dir] = 
                    WalkTheLine(rank, file, DIAGONALS_RANK[dir], DIAGONALS_FILE[dir]);
            }
