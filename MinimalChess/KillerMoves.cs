...
internal sealed class KillerMoves(int width)
{
    ...
    public void Add(Move move, int depth)
    {
        ...
        // 1. We shift all moves by one slot to make room but overwrite a potential dublicate of 'move'
        // then store the new 'move' at [0] 
        int last = index0;
