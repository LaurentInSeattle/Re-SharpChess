...
/// <summary> The player playing black. </summary>
public class PlayerBlack : Player
{
    ...
    /// <summary> Gets PawnAttackRightOffset. </summary>
    ...
    /// <summary> Set all the BLACK pieces at their starting positions. </summary>
